...
- Single invoice number series. The number is editable and defaults to one above the highest previously generated invoice.
...
```text
INV-1001-06 May 2026-Walk-in Customer-000-000-0000.pdf
```
